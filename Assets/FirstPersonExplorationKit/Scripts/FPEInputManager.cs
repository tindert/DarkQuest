...
namespace Whilefun.FPEKit
{
    ...
    public class FPEInputManager : MonoBehaviour
    {
        ...
        [SerializeField,Tooltip("If true, Gamepad Y Axis will be flipped for Look")]
        private bool flipGamepadYAxis = false;
        ...
        // To be called from external options menu, etc. where needed
        public bool FlipGamepadYAxis {
            get { return flipGamepadYAxis; }
            set { flipGamepadYAxis = value; }
        }
